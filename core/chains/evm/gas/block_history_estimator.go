...
// this Config.
func (b *BlockHistoryEstimator) isUsable(tx evmtypes.Transaction, cfg estimatorConfig, lggr logger.Logger) bool {
	...
	return chainSpecificIsUsable(tx, cfg.ChainType(), cfg.EvmMinGasPriceWei())
}
